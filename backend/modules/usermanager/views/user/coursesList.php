...
<?= \soft\adminty\GridView::widget([
    ...
    'pjax' => true,
    'panel' => [
      'before' => "<br>".tag('b',$model->fullname) ."ga tegishli kurslar ro'yxati",
    ],
    'cols' => [
        [
            'attribute' => 'title',
            ...
            'value' => function ($model) {
                return a($model->title, ['/kursmanager/kurs/view', 'id' => $model->id], ['data-pjax' => 0]);
            }
        ...
        [
            ...
            'value' => function ($model) {
                ...
                return "<small class='text-muted'>
                            <a href='" . to(['/kursmanager/kurs/sections', 'id' => $model->id]) . "' data-pjax='0'>
                            ...
                            <br>
                             <a href='" . to(['/kursmanager/kurs/students', 'id' => $model->id]) . "' data-pjax='0'>
