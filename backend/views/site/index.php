    ...
    <div class="col-xl-3 col-sm-6">
        <div class="card bg-c-blue text-white">
            <div class="card-block">
                <div class="row align-items-center">
                    <div class="col">
                        <p class="m-b-5">Pullik a'zoliklar</p>
                        <h4 class="m-b-0"><?= as_integer($payedEnrolls) ?></h4>
                    </div>
                    <div class="col col-auto text-right">
    ...
    <div class="col-xl-3 col-sm-6">
        <div class="card bg-c-orenge text-white">
            <div class="card-block">
                <div class="row align-items-center">
                    <div class="col">
                        <p class="m-b-5">Bepul a'zoliklar</p>
                        <h4 class="m-b-0"><?= as_integer($freeEnrolls) ?></h4>
                    </div>
                    <div class="col col-auto text-right">
    ...
    <div class="col-xl-3 col-sm-6">
        <div class="card bg-c-blue text-white">
            <div class="card-block">
                <div class="row align-items-center">
                    <div class="col">
                        <p class="m-b-5">Bug. pullik a'zo.</p>
                        <h4 class="m-b-0"><?= as_integer($todayPayedEnrolls) ?></h4>
                    </div>
                    <div class="col col-auto text-right">
                        <i class="fas fa-dollar-sign f-50 text-c-blue"></i>
                    </div>
    ...
    <div class="col-xl-3 col-sm-6">
        <div class="card bg-c-orenge text-white">
            <div class="card-block">
                <div class="row align-items-center">
                    <div class="col">
                        <p class="m-b-5">Bug. bepul a'zo.</p>
                        <h4 class="m-b-0"><?= as_integer($todayFreeEnrolls) ?></h4>
                    </div>
                    <div class="col col-auto text-right">
                        <i class="fas fa-hand-holding-usd f-50 text-c-orenge"></i>
                    </div>
