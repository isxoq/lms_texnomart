...
// document.querySelector('#preview_image').src="/admin/files/global/1111.png";

$("#category-image").change(function () {
  var $imgSrc = $(this).val();
  document.querySelector("#preview_image").src = $imgSrc;
});

$("#category-name_uz").keyup(function () {

    let lotin_word = $(this).val();
    $("#category-name_kr").val(lotinKril(lotin_word));

});

// $("#category-name_kr").keyup(function () {

//     let kiril_word = $(this).val();
//     $("#category-name_uz").val(krilLotin(kiril_word));
