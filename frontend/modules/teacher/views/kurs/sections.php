    ...
    'cols' => [
        [
            ...
            'value' => function($model){
                /** @var Section $model */
                return a($model->title, ['section/view', 'id' => $model->id], ['data-pjax' => 0, 'class' => 'text-primary']);
            }
        ],
        [
            'width' => '200px',
            ...
            'value' => function ($model) {
                ...
                return "<small class='text-muted'>
                            <a href='" . to(['section/lessons', 'id' => $model->id]) . "'  data-pjax='0'  class='text-primary'><b>Jami mavzu: </b> {$model->lessonsCount}</a>
                            <br>
