...
<?php if (!$this->hasUser): ?>
    <li><a href="<?= to(['signup/index']) ?>" role="modal-remote"><span class="flaticon-edit"></span> <?= t('Register') ?></a></li>
    <li><a href="<?= to(['site/login', 'return_url' => Url::current() ]) ?>" role="modal-remote"><span class="flaticon-user"></span> <?= t('Enter') ?></a></li>
<?php else: ?>
