 ...
 */
class MultiLinkPager extends \yii\widgets\LinkPager
{
    /**
    ...
    protected function renderPageButton($label, $page, $class, $disabled, $active)
    {
        ...
        if ($active && !$this->activePageAsLink) {
            Html::addCssStyle($linkOptions, ['background-color' => '#01a9ac', 'border-color' => '#01a9ac', 'color' => 'white', 'padding-bottom' => '7px' ]);
